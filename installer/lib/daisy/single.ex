defmodule Daisy.New.Single do
  ...
  template(:dev, [
    ...
    {:eex, :web, "components/alert.ex": "lib/daisy_ui_components/alert.ex"},
    {:eex, :web, "components/avatar.ex": "lib/daisy_ui_components/avatar.ex"},
    {:eex, :web, "components/back.ex": "lib/daisy_ui_components/back.ex"},
    {:eex, :web, "components/badge.ex": "lib/daisy_ui_components/badge.ex"},
    {:eex, :web,
     "components/breadcrumbs.ex": "lib/daisy_ui_components/breadcrumbs.ex"},
    {:eex, :web, "components/button.ex": "lib/daisy_ui_components/button.ex"},
    {:eex, :web, "components/card.ex": "lib/daisy_ui_components/card.ex"},
    {:eex, :web, "components/checkbox.ex": "lib/daisy_ui_components/checkbox.ex"},
    {:eex, :web, "components/drawer.ex": "lib/daisy_ui_components/drawer.ex"},
    {:eex, :web, "components/dropdown.ex": "lib/daisy_ui_components/dropdown.ex"},
    {:eex, :web, "components/fieldset.ex": "lib/daisy_ui_components/fieldset.ex"},
    {:eex, :web, "components/footer.ex": "lib/daisy_ui_components/footer.ex"},
    {:eex, :web, "components/form.ex": "lib/daisy_ui_components/form.ex"},
    {:eex, :web, "components/header.ex": "lib/daisy_ui_components/header.ex"},
    {:eex, :web, "components/hero.ex": "lib/daisy_ui_components/hero.ex"},
    {:eex, :web, "components/icon.ex": "lib/daisy_ui_components/icon.ex"},
    {:eex, :web, "components/indicator.ex": "lib/daisy_ui_components/indicator.ex"},
    {:eex, :web, "components/input.ex": "lib/daisy_ui_components/input.ex"},
    {:eex, :web, "components/join.ex": "lib/daisy_ui_components/join.ex"},
    {:eex, :web, "components/label.ex": "lib/daisy_ui_components/label.ex"},
    {:eex, :web, "components/list.ex": "lib/daisy_ui_components/list.ex"},
    {:eex, :web, "components/loading.ex": "lib/daisy_ui_components/loading.ex"},
    {:eex, :web, "components/menu.ex": "lib/daisy_ui_components/menu.ex"},
    {:eex, :web, "components/modal.ex": "lib/daisy_ui_components/modal.ex"},
    {:eex, :web, "components/navbar.ex": "lib/daisy_ui_components/navbar.ex"},
    {:eex, :web,
     "components/pagination.ex": "lib/daisy_ui_components/pagination.ex"},
    {:eex, :web, "components/progress.ex": "lib/daisy_ui_components/progress.ex"},
    {:eex, :web, "components/radio.ex": "lib/daisy_ui_components/radio.ex"},
    {:eex, :web, "components/range.ex": "lib/daisy_ui_components/range.ex"},
    {:eex, :web, "components/select.ex": "lib/daisy_ui_components/select.ex"},
    {:eex, :web, "components/stat.ex": "lib/daisy_ui_components/stat.ex"},
    {:eex, :web, "components/swap.ex": "lib/daisy_ui_components/swap.ex"},
    {:eex, :web, "components/table.ex": "lib/daisy_ui_components/table.ex"},
    {:eex, :web,
     "components/text_input.ex": "lib/daisy_ui_components/text_input.ex"},
    {:eex, :web, "components/textarea.ex": "lib/daisy_ui_components/textarea.ex"},
    {:eex, :web, "components/toggle.ex": "lib/daisy_ui_components/toggle.ex"},
    {:eex, :web, "components/tooltip.ex": "lib/daisy_ui_components/tooltip.ex"},
    {:eex, :web, "components/utils.ex": "lib/daisy_ui_components/utils.ex"},
    {:eex, :web, "daisy_ui_components.ex": "lib/daisy_ui_components.ex"}
  ])
